...
pub fn view() -> crate::View {
    { let _x_25 = crate::Wallpaper { file: alloc::string::String::from("alps.jpg"), label: alloc::string::String::from("Alpine Dawn"), author: alloc::string::String::from("Unsplash"), authorUrl: alloc::string::String::from("https://unsplash.com/?utm_source=Hologram_AI&utm_medium=referral") }; { let _x_30 = crate::Wallpaper { file: alloc::string::String::from("galaxy.jpg"), label: alloc::string::String::from("Galaxy"), author: alloc::string::String::from("Tiago Ferreira"), authorUrl: alloc::string::String::from("https://unsplash.com/@tiago_f_ferreira?utm_source=Hologram_AI&utm_medium=referral") }; { let _x_35 = crate::Wallpaper { file: alloc::string::String::from("aurora.jpg"), label: alloc::string::String::from("Aurora"), author: alloc::string::String::from("Lightscape"), authorUrl: alloc::string::String::from("https://unsplash.com/@lightscape?utm_source=Hologram_AI&utm_medium=referral") }; { let _x_37 = alloc::vec![_x_35]; { let _x_38 = { let mut __list = alloc::vec![_x_30]; __list.extend(_x_37); __list }; { let _x_39 = { let mut __list = alloc::vec![_x_25]; __list.extend(_x_38); __list }; { let _x_53 = crate::PaidModel { id: alloc::string::String::from("qwen/qwen3.8-flash"), label: alloc::string::String::from("Qwen 3.8 Flash") }; { let _x_56 = crate::PaidModel { id: alloc::string::String::from("deepseek/deepseek-v4.1-flash"), label: alloc::string::String::from("DeepSeek V4.1 Flash") }; { let _x_59 = crate::PaidModel { id: alloc::string::String::from("nvidia/nemotron-3.5-lightning:free"), label: alloc::string::String::from("Nemotron 3.5, free") }; { let _x_61 = alloc::vec![_x_59]; { let _x_62 = { let mut __list = alloc::vec![_x_56]; __list.extend(_x_61); __list }; { let _x_63 = { let mut __list = alloc::vec![_x_53]; __list.extend(_x_62); __list }; { let _x_81 = crate::View { headline: alloc::string::String::from("Own Your Ideas"), lede: alloc::string::String::from("Describe it. It builds, runs and stays yours, in this browser, on no server."), promptPlaceholder: alloc::string::String::from("What do you want to build?"), sendLabel: alloc::string::String::from("Build"), buildingLabel: alloc::string::String::from("building in your browser"), previewLabel: alloc::string::String::from("Preview"), snapshotLabel: alloc::string::String::from("Sealed"), rollbackLabel: alloc::string::String::from("Go back"), refusedLabel: alloc::string::String::from("Refused: not what it claims to be"), offlineLabel: alloc::string::String::from("offline, working from your device"), loadingLabel: alloc::string::String::from("getting the model, once"), servedLabel: alloc::string::String::from("Instant, from the seal"), sealedLabel: alloc::string::String::from("Sealed"), rederiveLabel: alloc::string::String::from("Check again"), identicalLabel: alloc::string::String::from("Checked, identical"), noGpuLabel: alloc::string::String::from("This browser cannot run the model. Try Chrome or Edge on a computer."), modelLabel: alloc::string::String::from("BitNet 2B, on your device"), appearanceLabel: alloc::string::String::from("Appearance"), darkLabel: alloc::string::String::from("Dark"), lightLabel: alloc::string::String::from("Light"), immersiveLabel: alloc::string::String::from("Immersive"), wallpapers: _x_39, localLabel: alloc::string::String::from("On your device"), paidLabel: alloc::string::String::from("Paid"), keyLabel: alloc::string::String::from("OpenRouter key"), keyPlaceholder: alloc::string::String::from("Paste your OpenRouter key"), keySavedLabel: alloc::string::String::from("Key kept on this device"), paidOnceLabel: alloc::string::String::from("Paid once, then free from the seal"), costLabel: alloc::string::String::from("Paid"), freeLabel: alloc::string::String::from("Free"), noKeyLabel: alloc::string::String::from("Add your OpenRouter key to use paid models"), noCreditLabel: alloc::string::String::from("Your OpenRouter account has no credit"), providerBusyLabel: alloc::string::String::from("That model is busy right now. Try again or pick another"), paidOfflineLabel: alloc::string::String::from("Paid models need the network"), paidModels: _x_63, connectLabel: alloc::string::String::from("Connect"), connectedLabel: alloc::string::String::from("Connected"), listeningLabel: alloc::string::String::from("Listening for the relay"), notConnectedLabel: alloc::string::String::from("Not connected"), runLabel: alloc::string::String::from("Run this once, on this computer"), verifyLabel: alloc::string::String::from("Verify the file"), baseUrlLabel: alloc::string::String::from("Base URL"), anyKeyLabel: alloc::string::String::from("Any key works, for example local"), modelIdLabel: alloc::string::String::from("Model"), testLabel: alloc::string::String::from("Send a test request"), stayOpenLabel: alloc::string::String::from("Nothing leaves your device. Keep this tab open."), askLabel: alloc::string::String::from("Your browser may ask to let this page reach your computer."), secondTabLabel: alloc::string::String::from("Another tab is already serving"), copyLabel: alloc::string::String::from("Copy"), copiedLabel: alloc::string::String::from("Copied"), macLabel: alloc::string::String::from("macOS / Linux"), windowsLabel: alloc::string::String::from("Windows") }; _x_81 } } } } } } } } } } } } }
}
